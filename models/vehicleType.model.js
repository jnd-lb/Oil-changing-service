...
const initvehicleType = (sequelize,DataTypes)=>{
        const vehicleType = sequelize.define("vehicles_types", {
            name: {
...
module.exports =  initvehicleType(sequelize,DataTypes)